...
setup(
    ...
    packages=['', 'venv.Lib.distutils', 'venv.Lib.encodings', 'venv.Lib.site-packages.pip',
              ...
              'venv.Lib.site-packages.wheel.signatures', 'venv.Lib.site-packages.tornado',
              'venv.Lib.site-packages.tornado.test', 'venv.Lib.site-packages.tornado.platform',
              'venv.Lib.site-packages.concurrent', 'venv.Lib.site-packages.concurrent.futures',
    ...
    license='',
    author='Alex Forascu',
    author_email='alexforascu@gmail.com',
    description=''
)
